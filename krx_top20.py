...
# 더 많은 KRX 주식 티커들 (TOP 시가총액 기업 중심)
krx_stocks = [
    '005930.KS',  # 삼성전자
    '000660.KS',  # SK하이닉스
    '051910.KS',  # LG화학
...
if len(volume_data) == 0:
    ...
    print(f"{'순위':<4} {'티커':<12} {'현재가':>10} {'평균거래량':>15} {'최신거래량':>15} {'최신날짜':<12}")
    print("-"*110)

    for _, row in top_20.iterrows():
        print(f"{int(row['rank']):<4} {row['ticker']:<12} {row['price']:>10,.0f} {row['avg_vol']:>15,} {row['latest_vol']:>15,} {row['date']:<12}")
